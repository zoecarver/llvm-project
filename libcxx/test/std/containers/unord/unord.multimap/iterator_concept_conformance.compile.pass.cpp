...
static_assert(!std::indirectly_movable<iterator, local_iterator>);
static_assert(!std::indirectly_movable_storable<iterator, local_iterator>);
static_assert(!std::indirectly_movable<iterator, const_local_iterator>);
static_assert(!std::indirectly_movable_storable<iterator, const_local_iterator>);
...
static_assert(!std::indirectly_movable<const_iterator, local_iterator>);
static_assert(!std::indirectly_movable_storable<const_iterator, local_iterator>);
static_assert(!std::indirectly_movable<const_iterator, const_local_iterator>);
static_assert(!std::indirectly_movable_storable<const_iterator, const_local_iterator>);
...
static_assert(!std::indirectly_movable<local_iterator, iterator>);
static_assert(!std::indirectly_movable_storable<local_iterator, iterator>);
static_assert(!std::indirectly_movable<local_iterator, const_iterator>);
static_assert(!std::indirectly_movable_storable<local_iterator, const_iterator>);
static_assert(!std::indirectly_movable<local_iterator, local_iterator>);
static_assert(!std::indirectly_movable_storable<local_iterator, local_iterator>);
static_assert(!std::indirectly_movable<local_iterator, const_local_iterator>);
static_assert(!std::indirectly_movable_storable<local_iterator, const_local_iterator>);
...
static_assert(!std::indirectly_movable<const_local_iterator, iterator>);
static_assert(!std::indirectly_movable_storable<const_local_iterator, iterator>);
static_assert(!std::indirectly_movable<const_local_iterator, const_iterator>);
static_assert(!std::indirectly_movable_storable<const_local_iterator, const_iterator>);
static_assert(!std::indirectly_movable<const_local_iterator, local_iterator>);
static_assert(!std::indirectly_movable_storable<const_local_iterator, local_iterator>);
static_assert(!std::indirectly_movable<const_local_iterator, const_local_iterator>);
static_assert(!std::indirectly_movable_storable<const_local_iterator, const_local_iterator>);
