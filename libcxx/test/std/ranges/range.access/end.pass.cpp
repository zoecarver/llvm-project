...
static_assert(!std::is_invocable_v<RangeEndT, Incomplete[2]>);
static_assert(!std::is_invocable_v<RangeEndT, Incomplete[2][2]>);
static_assert(!std::is_invocable_v<RangeEndT, int []>);
static_assert(!std::is_invocable_v<RangeEndT, int (&&)[]>);
static_assert(!std::is_invocable_v<RangeEndT, int (&)[]>);
static_assert(!std::is_invocable_v<RangeEndT, int [1]>);
static_assert(!std::is_invocable_v<RangeEndT, int (&&)[1]>);
static_assert( std::is_invocable_v<RangeEndT, int (&)[1]>);
